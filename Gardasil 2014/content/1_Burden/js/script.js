...
$('ul.tabs li.second a').click(function(){
	//hideGraphsAnimate();
	isFirstTab = true;
	isSecondTab = false;
});
...
$('.Dukoral-Immunogenicity ul.tabs li:first-child').click(function(){
	$('.container').removeClass('three').removeClass('two').addClass('one');
})

$('.Dukoral-Immunogenicity ul.tabs li.second').click(function(){
	$('.container').removeClass('three').addClass('two').removeClass('one');
})

$('.Dukoral-Immunogenicity ul.tabs li:last-child').click(function(){
	$('.container').addClass('three').removeClass('two').removeClass('one');
})
