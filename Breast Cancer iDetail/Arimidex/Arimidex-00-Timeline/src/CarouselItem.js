...
SKY.CarouselItem = function(element, carousel) {
	...
	this.imageElement = element.find('.item');
	this.image = this.imageElement.get(0);
	this.vline = element.find('.vline');
	this.circle = element.find('.circle');
	this.rosette = element.find('.rosette');
	this.content = element.children('.sc-content');
	//this.line = $(this+':before')
...
SKY.CarouselItem.prototype = {
	...
	/**
	 * Returns the item's rosette div.
	 * 
	 * @return {element} The rosette div.
	 */	
	getRosette: function() {
